      ...
      builder: (context, model, _) => SplitScreen(
        leftView: Form(
          ...
          child: Column(
            ...
            children: [
              HeadingWithSubtitle(heading: "LMS Settings",subtitle: "Let’s change that bad password, first.",),
              SizedBox(height: 30,),
              CustomTextField(
                labelText: "Current Password",
                hintText: "the secret you hold",
                isPassword: true,
                validator: (value) => value != model.lmsService.user.password ? "This should match your current password" : null,
              ...
              CustomTextField(
                ...
                validator: (currentVal) => currentVal != model.newPassword ? "Passwords do not match" : null, 
                enabled: !model.isBusy,
              ),
              SizedBox(
                height: 30,
              ),
              SimpleWideButton(text: "Change Password", loading: model.isBusy, onPressed: () {
